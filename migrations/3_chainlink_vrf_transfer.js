const VRFv2ConsumerTransfer = artifacts.require("VRFv2ConsumerTransfer");
...
module.exports = async function (deployer, _network, accounts) {
    ...
    const _instanceERC721 = await MyToken.deployed();
    await deployer.deploy(VRFv2ConsumerTransfer, _subscriptionId, _coordinatorId, _keyHash, _instanceERC721.address, {overwrite: _overwrite});
};
